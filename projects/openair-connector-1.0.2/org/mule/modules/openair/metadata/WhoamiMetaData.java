...
public class WhoamiMetaData
extends AbstractMetaData {
    @Override
    public List<MetaDataKey> getMetadataKeys() throws WsdlDatasenseException {
        return this.getOperationMetaDataKey("whoami", "whoami", "WhoAmI", this.getClass().getSimpleName());
    }
    ...
    public MetaData getOutputMetadata(MetaDataKey key) throws WsdlDatasenseException {
        Map<String, MetaData> outputMetaData = this.getWsdlDatasenseParser().getOutputMetaData(this.getOperation("whoami"));
        return this.addOaAttributeOaSwitchToMetaDataObject(outputMetaData.get("whoamiReturn"));
    }
}
