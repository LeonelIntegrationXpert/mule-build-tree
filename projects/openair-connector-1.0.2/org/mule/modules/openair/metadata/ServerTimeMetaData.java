...
public class ServerTimeMetaData
extends AbstractMetaData {
    @Override
    public List<MetaDataKey> getMetadataKeys() throws WsdlDatasenseException {
        return this.getOperationMetaDataKey("servertime", "serverTime", "Server Time", this.getClass().getSimpleName());
    }
    ...
    public MetaData getOutputMetadata(MetaDataKey key) throws WsdlDatasenseException {
        Map<String, MetaData> outputMetaData = this.getWsdlDatasenseParser().getOutputMetaData(this.getOperation("servertime"));
        return outputMetaData.get("servertimeReturn");
    }
}
