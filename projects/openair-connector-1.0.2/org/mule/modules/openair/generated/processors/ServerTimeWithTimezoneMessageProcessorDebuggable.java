...
public class ServerTimeWithTimezoneMessageProcessorDebuggable
extends ServerTimeWithTimezoneMessageProcessor
implements DebugInfoProvider {
    public ServerTimeWithTimezoneMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(this.createDevKitFieldDebugInfo("request", "Request", XMLStreamReader.class, this.request, muleEvent));
        fieldDebugInfoList.add(this.createDevKitFieldDebugInfo("oaObject", "oaObject", String.class, this.oaObject, muleEvent));
