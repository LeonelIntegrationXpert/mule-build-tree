...
public class GetCrystalInfoMessageProcessor
extends DevkitBasedMessageProcessor
implements MessageProcessor,
OperationMetaDataEnabled {
    public GetCrystalInfoMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        DefaultMetaDataKey metaDataKey = new DefaultMetaDataKey("OpenAirGetCrystalInfoMetaData", null);
        metaDataKey.setCategory("GetCrystalInfoMetaData");
        metaDataKey.addProperty((MetaDataKeyProperty)new TypeDescribingProperty(TypeDescribingProperty.TypeScope.OUTPUT, "getCrystalInfo"));
        ...
        DefaultMetaDataKey keyForStudio = new DefaultMetaDataKey("OpenAirGetCrystalInfoMetaData", null);
        keyForStudio.setCategory("GetCrystalInfoMetaData");
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult(null, Result.Status.FAILURE, "There was an error processing metadata at OpenAirConnector at getCrystalInfo retrieving was successful but result is null");
                }
                return metadata;
            }
            catch (Exception e) {
