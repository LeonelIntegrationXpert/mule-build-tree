...
public class CreateAccountMessageProcessorDebuggable
extends CreateAccountMessageProcessor
implements DebugInfoProvider {
    public CreateAccountMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(this.createDevKitFieldDebugInfo("oaObject", "Oa object", String.class, this.oaObject, muleEvent));
