...
public class ServerTimeMessageProcessor
extends DevkitBasedMessageProcessor
implements MessageProcessor,
OperationMetaDataEnabled {
    public ServerTimeMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        DefaultMetaDataKey metaDataKey = new DefaultMetaDataKey("OpenAirServerTimeMetaData", null);
        metaDataKey.setCategory("ServerTimeMetaData");
        metaDataKey.addProperty((MetaDataKeyProperty)new TypeDescribingProperty(TypeDescribingProperty.TypeScope.OUTPUT, "serverTime"));
        ...
        DefaultMetaDataKey keyForStudio = new DefaultMetaDataKey("OpenAirServerTimeMetaData", null);
        keyForStudio.setCategory("ServerTimeMetaData");
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult(null, Result.Status.FAILURE, "There was an error processing metadata at OpenAirConnector at serverTime retrieving was successful but result is null");
                }
                return metadata;
            }
            catch (Exception e) {
