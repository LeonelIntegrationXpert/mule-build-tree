...
public class EeTransformSetPayloadResourceSyntacticallyValidErrors
extends EeTransformResourceSyntacticallyValid {
    public EeTransformSetPayloadResourceSyntacticallyValidErrors(ClassLoader artifactRegionClassLoader, ExpressionLanguage expressionLanguage, Supplier<Validation.Level> level, Severity severity) {
